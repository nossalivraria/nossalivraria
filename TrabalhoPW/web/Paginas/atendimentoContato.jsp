...
<html>
    <head>
        ...
        <title>Atendimento/Contatos</title>
    ...
    <body>
        <div id="topo">
            <div id="cabecalho">
             ...
             <div id="tituloMaior">
                <div class="sombra22">CONTATOS
                    <div class="sombra21">CONTATOS
                        <div class="texto2">CONTATOS
                        </div>
                    </div>
                </div>
            </div>
            <div id="texto">
                <div id="titulo">Mirelle</div>
                <div id="endereço">mirellycristina.si@gmail.com</div>
            </div>
            </div>
        <div id="rodape">
